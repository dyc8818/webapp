...
(function (global, factory) {
    ...
    function on$$1(el, type, listener, useCapture) {
        ...
        type.split(' ').forEach(function (type) {
            return toNode$$1(el).addEventListener(type, listener, useCapture);
        });
    }
    ...
    function off$$1(el, type, listener, useCapture) {
        ...
        type.split(' ').forEach(function (type) {
            return toNode$$1(el).removeEventListener(type, listener, useCapture);
        });
    }
...
// default strategy
    ...
    function listen(cb) {
        ...
        return promise$$1(function (resolve) {
            ...
            one$$1(window, 'message', function (data) {
                return resolve(data);
            }, false, function (ref) {
                var data = ref.data;
...
*/
        ...
        on$$1(document, pointerUp, function (ref) {
            ...
            if (touch.x2 && Math.abs(touch.x1 - touch.x2) > 30 || touch.y2 && Math.abs(touch.y1 - touch.y2) > 30) {
                ...
                tapTimeout = setTimeout(function () {
                    return touch.el && trigger$$1(touch.el, 'tap');
                });
    ...
    var boot = function (UIkit) {
        ...
        if (Observer) {
            ...
            ready$$1(function () {
                ...
                on$$1(doc$$1, 'DOMNodeInserted', function (e) {
                    return apply(e.target, connect);
                });
                on$$1(doc$$1, 'DOMNodeRemoved', function (e) {
    ...
    var stateAPI = function (UIkit) {
        ...
        UIkit.prototype._initObserver = function () {
            ...
            attrs = isArray$$1(attrs) ? attrs : Object.keys(props).map(function (key) {
    ...
    var classAPI = function (UIkit) {
        ...
        function apply(el, args, fn) {
            (args = getArgs(args, el)) && (supportsMultiple
                ...
                : args.slice(1).forEach(function (cls) {
        ...
        function getArgs(args, el) {
            ...
            args.forEach(function (arg, i) {
                    return i > 0 && isString$$1(arg) && ~arg.indexOf(' ') && Array.prototype.splice.apply(args, [i, 1].concat(args[i].split(' ')));
                }
            );
        ...
        methods: {
            ...
            toggleElement: function toggleElement(targets, show, animate) {
                ...
                return promise$$1(function (resolve) {
                    ...
                    this$1._queued = targets.not(toggles = targets.filter(function (_, el) {
                ...
                return Transition$$1.cancel(el).then(function () {
                    ...
                    if (Transition$$1.inProgress(el)) {
                        return promise$$1.resolve().then(function () {
                            return this$1._toggleHeight(el, show);
                        });
                    }
                    ...
                    return (show
                        ? Transition$$1.start(el, assign$$1(this$1.initProps, {
                            overflow: 'hidden',
                            height: endHeight
            ...
            computed: {
                ...
                items: function items() {
                    ...
                    this._changed = !this._items
                        ...
                        || items.toArray().some(function (el, i) {
    ...
    var Modal$1 = function (UIkit) {
        ...
        UIkit.modal.alert = function (message, options) {
            ...
            return promise$$1(
                function (resolve) {
                    return UIkit.modal.dialog(("<div class=\"uk-modal-body\">" + (isString$$1(message) ? message : $__default(message).html()) + "</div><div class=\"uk-modal-footer uk-text-right\"><button class=\"uk-button uk-button-primary uk-modal-close\" autofocus>" + (options.labels.ok) + "</button></div>"), options).$el.on('hide', resolve);
                }
            );
        };
    ...
    var Navbar = function (UIkit) {
        ...
        UIkit.component('navbar', {
            ...
            update: function update() {
                ...
                UIkit.drop($__default(((this.dropdown) + " ." + (this.clsDrop)), this.$el), assign$$1({}, this.$props, {
            ...
            methods: {
                ...
                transitionTo: function transitionTo(height) {
                    ...
                    return Transition$$1.cancel(this.$el).then(function () {
                        return Transition$$1.start(this$1.$el, {height: height}, this$1.duration).then(null, noop$$1);
                    });
                }
        ...
        UIkit.component('responsive', {
            ...
            update: {
                ...
                write: function write() {
                    ...
                    if (this.dim) {
                        this.$el.height(Dimensions$$1.contain({
                            height: this.height,
                            width: this.width
                        }, this.dim).height);
                    }
...

                {
                    ...
                    read: function read() {
                        ...
                        var scroll = window.pageYOffset + this.offset,
                            max = docHeight$$1() - window.innerHeight + this.offset;
                        ...
                        if (this.inactive
                            ...
                            if (this.animation && scroll > this.topOffset) {
                                Animation$$1.cancel(this.$el).then(function () {
                                    return Animation$$1.out(this$1.$el, this$1.animation);
                                }).then(function () {
                                    return this$1.hide();
                                });
                            } else {
                ...
                show: function show(dir) {
                    ...
                    if (dir < 0) {
                        ...
                        return [
                            {
                                opacity: 0.3,
                                transform: ("scale3d(" + (1 - diff) + ", " + (1 - diff) + ", 1) translate3d(-20%, 0, 0)"),
                                zIndex: -1
                            },
                ...
                translate: function translate(percent, dir) {
                    ...
                    if (dir < 0) {
                        ...
                        return [
                            ...
                            {
                                opacity: 0.3 + 0.7 * percent,
                                transform: ("scale3d(" + scale + ", " + scale + ", 1) translate3d(" + (-20 * (1 - percent)) + "%, 0, 0)"),
                                zIndex: -1
                            }];
                    } else {
                        ...
                        return [
                            {
                                ...
                                transform: ("scale3d(" + scale + ", " + scale + ", 1) translate3d(" + (-20 * percent) + "%, 0, 0)"),
                                zIndex: -1
                            },
            ...
            computed: {
                ...
                toggles: function toggles() {
                    ...
                    this._changed = !this._toggles
                        ...
                        || toggles.toArray().some(function (el, i) {
...

                {
                    ...
                    handler: function handler(_, item) {
                        ...
                        if (type === 'image' || source.match(/\.(jp(e)?g|png|gif|svg)$/i)) {
                            ...
                            ajax$$1({
                                type: 'GET',
                                url: ("//vimeo.com/api/oembed.json?url=" + (encodeURI(source))),
                                jsonp: 'callback',
                                dataType: 'jsonp'
                            })
                                .then(function (ref) {
